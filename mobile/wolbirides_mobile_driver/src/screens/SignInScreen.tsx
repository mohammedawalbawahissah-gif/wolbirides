    ...
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1 }}>
        <View style={styles.hero}>
          ...
          <Text style={styles.heroTitle}>Welcome back, driver.</Text>
          <Text style={styles.heroSubtitle}>Go online, accept rides, and get paid.</Text>
        </View>
        ...
        <ScrollView contentContainerStyle={styles.formArea} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.switchRow}>
            <Text style={styles.switchText}>New driver? </Text>
